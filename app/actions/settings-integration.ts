...
export async function getIntegrationSettings() {
  ...
  try {
    ...
    const safeData = {
      ...
      comdata_api_base_url: integrationData.comdata_api_base_url || "",
      wex_api_base_url: integrationData.wex_api_base_url || "",
      efs_api_base_url: integrationData.efs_api_base_url || "",
