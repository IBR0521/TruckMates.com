  ...
  try {
    ...
    for (const load of loads || []) {
      ...
      allJobs.push({
        ...
        driver_name: (load.driver as { name?: string } | null)?.name || null,
        truck_id: load.truck_id,
        truck_number: (load.truck as { truck_number?: string } | null)?.truck_number || null,
        origin: load.origin,
    ...
    for (const route of routes || []) {
      ...
      allJobs.push({
        ...
        driver_name: (route.driver as { name?: string } | null)?.name || null,
        truck_id: route.truck_id,
        truck_number: (route.truck as { truck_number?: string } | null)?.truck_number || null,
        origin: route.origin,
