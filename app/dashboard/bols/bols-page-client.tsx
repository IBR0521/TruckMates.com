...
export default function BOLsPageClient({
  initialBOLs = null,
  initialError = null,
}: {
  initialBOLs?: unknown[] | null
  initialError?: string | null
}) {
  const [bolsList, setBolsList] = useState<BOLListRow[]>(() => (initialBOLs as BOLListRow[]) || [])
  const [isLoading, setIsLoading] = useState(() => !initialBOLs && !initialError)
  const [hasLoadedOnce, setHasLoadedOnce] = useState(() => !!initialBOLs || !!initialError)
