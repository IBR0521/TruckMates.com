    ...
    async function loadData() {
      ...
      if (truckResult.data) {
        ...
        setFormData({
          ...
          serialNumber: truck.serial_number || "",
          height: truck.height || "",
          grossVehicleWeight: truck.gross_vehicle_weight ? truck.gross_vehicle_weight.toString() : "",
          color: truck.color || "",
          ownerName: truck.owner_name || "",
          cost: truck.cost ? truck.cost.toString() : "",
          fuelType: truck.fuel_type || "diesel",
          lastKnownAddress: truck.last_known_address || "",
          ...
          licenseExpiryDate: truck.license_expiry_date || "",
          inspectionDate: truck.inspection_date || "",
          insuranceProvider: truck.insurance_provider || "",
