...
type TrailerOption = { id: string; trailer_number?: string | null; trailer_type?: string | null }
type RouteOption = { id: string; name?: string | null; origin?: string | null; destination?: string | null }
type LoadUpdateResultData = {
  autoGeneratedInvoice?: { id: string; invoice_number: string }
}

const asDeliveryPoint = (value: unknown, fallbackNumber: number): DeliveryPoint | null => {
  if (!value || typeof value !== "object") return null
  const obj = value as Record<string, unknown>
  const parsedNumber = Number(obj.delivery_number)
  return {
    id: typeof obj.id === "string" ? obj.id : undefined,
    delivery_number: Number.isFinite(parsedNumber) ? parsedNumber : fallbackNumber,
    ...
    delivery_type: typeof obj.delivery_type === "string" ? obj.delivery_type : undefined,
    priority: typeof obj.priority === "string" ? obj.priority : undefined,
    weight_kg: typeof obj.weight_kg === "number" ? obj.weight_kg : undefined,
    weight_lbs: typeof obj.weight_lbs === "number" ? obj.weight_lbs : undefined,
    pieces: typeof obj.pieces === "number" ? obj.pieces : undefined,
    pallets: typeof obj.pallets === "number" ? obj.pallets : undefined,
    boxes: typeof obj.boxes === "number" ? obj.boxes : undefined,
    carts: typeof obj.carts === "number" ? obj.carts : undefined,
    volume_cubic_meters: typeof obj.volume_cubic_meters === "number" ? obj.volume_cubic_meters : undefined,
    delivery_instructions:
      typeof obj.delivery_instructions === "string" ? obj.delivery_instructions : undefined,
    special_handling: typeof obj.special_handling === "string" ? obj.special_handling : undefined,
    requires_liftgate: typeof obj.requires_liftgate === "boolean" ? obj.requires_liftgate : undefined,
    requires_inside_delivery:
      typeof obj.requires_inside_delivery === "boolean" ? obj.requires_inside_delivery : undefined,
    requires_appointment:
      typeof obj.requires_appointment === "boolean" ? obj.requires_appointment : undefined,
    appointment_time: typeof obj.appointment_time === "string" ? obj.appointment_time : undefined,
    scheduled_delivery_date:
      typeof obj.scheduled_delivery_date === "string" ? obj.scheduled_delivery_date : undefined,
    scheduled_delivery_time:
      typeof obj.scheduled_delivery_time === "string" ? obj.scheduled_delivery_time : undefined,
    time_window_start: typeof obj.time_window_start === "string" ? obj.time_window_start : undefined,
    time_window_end: typeof obj.time_window_end === "string" ? obj.time_window_end : undefined,
    reference_number: typeof obj.reference_number === "string" ? obj.reference_number : undefined,
...
export default function EditLoadPage({ params }: { params: Promise<{ id: string }> }) {
      ...
      if (loadResult.data) {
        ...
        if (load.delivery_type === "multi") {
          ...
          if (deliveryPointsResult.data) {
            setDeliveryPoints(
              (deliveryPointsResult.data as unknown[])
                .map((point, index) => asDeliveryPoint(point, index + 1))
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const updateData = result.data as LoadUpdateResultData | null
    if (updateData?.autoGeneratedInvoice) {
      const invoice = updateData.autoGeneratedInvoice
      toast.success(
