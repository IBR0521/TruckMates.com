...
type DeliveryPointOption = { id?: string; location_name?: string | null; address?: string | null; [key: string]: unknown }
...
export default function EditLoadPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [deliveryPoints, setDeliveryPoints] = useState<DeliveryPointOption[]>([])
