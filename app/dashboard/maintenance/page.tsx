...
import { Plus, Download, Eye, AlertTriangle, CheckCircle, Wrench } from "lucide-react"
          ...
          {isLoading ? (
            ...
            <Card className="border border-border/50 p-8">
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-6">Get started by scheduling your first maintenance service</p>
                <Link href="/dashboard/maintenance/add">
                        ...
                        <td className="px-6 py-4">
                          <span
                            className={`px-3 py-1 rounded-full text-xs font-semibold ${
                              record.priority === "high" || record.priority === "High" ? "bg-red-500/20 text-red-400" : "bg-blue-500/20 text-blue-400"
                            }`}
                          >
