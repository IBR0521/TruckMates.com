-- Create IFTA Tax Rates Table
-- Run this migration to create the ifta_tax_rates table and related functions
...
-- Policy: Users can insert/update/delete tax rates for their company (relaxed for now)
...
DROP TRIGGER IF EXISTS trigger_update_ifta_tax_rates_updated_at ON public.ifta_tax_rates;
