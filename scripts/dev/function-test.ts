...
import * as trucksActions from "@/app/actions/trucks"
import * as loadsActions from "@/app/actions/loads"
import * as routesActions from "@/app/actions/routes"
import * as customersActions from "@/app/actions/customers"
import * as vendorsActions from "@/app/actions/vendors"
import * as accountingActions from "@/app/actions/accounting"
import * as bolActions from "@/app/actions/bol"
import * as eldActions from "@/app/actions/eld"
import * as iftaActions from "@/app/actions/ifta"
import * as reportsActions from "@/app/actions/reports"
import * as routeOptimizationActions from "@/app/actions/route-optimization"
import * as documentAnalysisActions from "@/app/actions/document-analysis"
import * as dispatchesActions from "@/app/actions/dispatches"
import * as addressBookActions from "@/app/actions/address-book"
import * as documentsActions from "@/app/actions/documents"
import * as dashboardActions from "@/app/actions/dashboard"
import { getCurrentUser } from "@/lib/auth/server"
import * as companyActions from "@/app/actions/company"
import * as settingsUsersActions from "@/app/actions/settings-users"
import * as notificationsActions from "@/app/actions/notifications"
import * as eldAdvancedActions from "@/app/actions/eld-advanced"
import * as eldInsightsActions from "@/app/actions/eld-insights"
import * as routeStopsActions from "@/app/actions/route-stops"
import * as loadDeliveryPointsActions from "@/app/actions/load-delivery-points"
import * as loadMileageActions from "@/app/actions/load-mileage"
import * as invoicesAutoActions from "@/app/actions/invoices-auto"
import * as maintenanceActions from "@/app/actions/maintenance"
import * as eldManualActions from "@/app/actions/eld-manual"
...
export async function testAllPlatformFunctions() {
  ...
  const getResultError = (value: unknown): string => {
  ...
  try {
          ...
          try {
            ...
            if (customer.data) {
              ...
              try {
                ...
                else pushFailed({ function: "getCustomerLoads", error: getResultError(loads) })
              } catch (error: unknown) {
              ...
              try {
                ...
                else pushFailed({ function: "getCustomerInvoices", error: getResultError(invoices) })
              } catch (error: unknown) {
              ...
              try {
                ...
                else pushFailed({ function: "getCustomerHistory", error: getResultError(history) })
              } catch (error: unknown) {
    ...
    try {
      ...
      else pushFailed({ function: "autoGenerateInvoicesFromLoads", error: getResultError(autoInvoices) })
    } catch (error: unknown) {
    ...
    try {
      const bolActionsWithTemplates = bolActions as typeof bolActions & {
        getBOLTemplates?: () => Promise<{ data?: unknown; error?: unknown }>
      }
      const templates = bolActionsWithTemplates.getBOLTemplates
        ? await bolActionsWithTemplates.getBOLTemplates()
        : { data: null, error: "BOL template function unavailable" }
        ...
        if (devices.data.length > 0) {
          ...
          try {
            ...
            if (trucks.data && trucks.data.length > 0) {
              ...
              else pushFailed({ function: "getELDMileageData", error: getResultError(mileage) })
            } else {
    ...
    try {
      ...
      if (drivers.data && drivers.data.length > 0) {
        try {
          ...
          else pushFailed({ function: "calculateRemainingHOS", error: getResultError(remainingHOS) })
        } catch (error: unknown) {
        ...
        try {
          ...
          else pushFailed({ function: "getDriverScorecard", error: getResultError(scorecard) })
        } catch (error: unknown) {
        ...
        try {
          ...
          else pushFailed({ function: "getDriverRecommendations", error: getResultError(recommendations) })
        } catch (error: unknown) {
    ...
    try {
      ...
      else pushFailed({ function: "getFleetHealth", error: getResultError(fleetHealth) })
    } catch (error: unknown) {
    ...
    try {
      ...
      else pushFailed({ function: "getRealtimeLocations", error: getResultError(locations) })
    } catch (error: unknown) {
    ...
    try {
      ...
      else pushFailed({ function: "getPredictiveAlerts", error: getResultError(alerts) })
    } catch (error: unknown) {
    ...
    try {
      ...
      else pushFailed({ function: "generateELDInsights", error: getResultError(insights) })
    } catch (error: unknown) {
