...
import DriverAppPage from "@/app/dashboard/eld/driver-app/page"
  ...
  async function loadData() {
    ...
    try {
      const [devicesResult, eventsResult] = await Promise.all([
        getELDDevices(),
        // Match /dashboard/eld/violations: only HOS violations, not every unresolved eld_events row.
        getELDEvents({ resolved: false, event_type: "hos_violation" }),
      ])
    ...
    <div className="relative w-full bg-background">
      ...
      <div className="p-8">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          {/* Unresolved HOS violations (same scope as Violations tab /violations page) */}
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <Select value={filterProvider} onValueChange={setFilterProvider}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="truckmates_mobile">Mobile / web driver ELD</SelectItem>
